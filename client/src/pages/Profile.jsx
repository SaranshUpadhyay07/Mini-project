          ...
          <form onSubmit={handleSave} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-slate-200 rounded-xl focus:border-orange-500 focus:outline-none"
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                type="submit"
                disabled={saving}
                className="flex-1 py-2 bg-orange-600 text-white rounded-xl font-bold disabled:opacity-60"
              >
